  ...
  aside#side-menu.flex
    ...
    .menu-nav.flex
      ...
      div
        ...
        .notification-count {{ store.CLICKED_IMG }}
</template>
...
import * as logoIco from '@/assets/img/Logo@3x.svg';
